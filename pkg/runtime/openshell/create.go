...
func (r *openshellRuntime) Create(ctx context.Context, params runtime.CreateParams) (runtime.RuntimeInfo, error) {
	...
	// Persist driver choice if specified (applies to all future workspaces)
	if params.OpenshellDriver != "" {
		r.config.Driver = params.OpenshellDriver
...
func (r *openshellRuntime) createSandbox(ctx context.Context, name string, l logger.Logger) error {
